<?php
	...
	$section_id = 'starters_theme_header_options';
	...
	$settings_id = 'starters_header_options';

	// Set the title of the current section.
	$section_title = 'Header Options';

	// Set the description of our current section.
	$section_desc = 'All configurable option in the header.';
