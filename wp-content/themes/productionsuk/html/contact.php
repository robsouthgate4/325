...
<head>
    ...
    <title>325 productions uk</title>
            ...
            <div class="row">
                <div class="col-md-5 col-lg-6">
                    <div class="contact-info-container">
                        <p>Contact us to arrange a free, no obligation meeting to discuss your video
                            production needs and budget constraints, or if you just fancy a chat we
                            welcome that too!<br/><br/>
                            After we’ve met, we’ll produce a project outline with full quote before you
                            make any commitment. <br/><br/>
                            Fill out our enquiry form below and we’ll be in touch as soon as possible.</p>
                    </div>
                    <form name="contactform" method="post" action="send_email.php" role="form" class="contact-form-container">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                   <textarea class="form-control" name="message" cols="30" rows="10" placeholder="Enter message" required></textarea>
                                </div>
                            </div>
                        </div>
